...
const defaultLabelSpecs = [
  { id: 1, applicationMode: "apl", brand: "11.2 Stella (HL,RG)", specNumber: "", bottleType: "S1NR - 11.2OZ", bodyLengthMm: 85.71, backLengthMm: 76.84, neckHeightMm: 67.16, neckLengthMm: 109.5, neckBottomCurveMm: 110.5, neckBottomCircumferenceMm: 104.5, neckWrapType: "auto", neckOverlapEdge: null, neckOverlapTargetMm: null, neckSeamWipeEnabled: true, neckSeamOverWipeDeg: 5, codeBoxCenterMm: 24 },
  { id: 2, applicationMode: "apl", brand: "12oz Bud Light Lime (9F)", specNumber: "2736-A", bottleType: "LNNR - 12 Oz", bodyLengthMm: 97.993, backLengthMm: 47.498, neckHeightMm: 27.61, neckLengthMm: 37.313, neckBottomCurveMm: 39.313, neckBottomCircumferenceMm: 105, neckWrapType: "auto", neckOverlapEdge: null, neckOverlapTargetMm: null, neckSeamWipeEnabled: true, neckSeamOverWipeDeg: 5, codeBoxCenterMm: 14 },
  { id: 3, applicationMode: "apl", brand: "12oz Land Shark (LN)", specNumber: "2162-B", bottleType: "HLNR - 12Oz", bodyLengthMm: 64.9, backLengthMm: 47.5, neckHeightMm: 0, neckLengthMm: 0, neckBottomCurveMm: 0, neckBottomCircumferenceMm: 104, neckWrapType: "auto", neckOverlapEdge: null, neckOverlapTargetMm: null, neckSeamWipeEnabled: true, neckSeamOverWipeDeg: 5, codeBoxCenterMm: 12 },
  { id: 4, applicationMode: "apl", brand: "12oz Platinum (NX)", specNumber: "2164-F", bottleType: "LNNR - 12 Oz", bodyLengthMm: 75.844, backLengthMm: 47.498, neckHeightMm: 18.0344, neckLengthMm: 35.585, neckBottomCurveMm: 37, neckBottomCircumferenceMm: 104, neckWrapType: "auto", neckOverlapEdge: null, neckOverlapTargetMm: null, neckSeamWipeEnabled: true, neckSeamOverWipeDeg: 5, codeBoxCenterMm: 14 },
  { id: 5, applicationMode: "apl", brand: "12oz Mic Family (T6,41,FO,79,BT,87)", specNumber: "2457-A", bottleType: "SSNR - 12 Oz", bodyLengthMm: 66.7, backLengthMm: 50.8, neckHeightMm: 40.001, neckLengthMm: 51.96, neckBottomCurveMm: 53, neckBottomCircumferenceMm: 105, neckWrapType: "auto", neckOverlapEdge: null, neckOverlapTargetMm: null, neckSeamWipeEnabled: true, neckSeamOverWipeDeg: 5, codeBoxCenterMm: 14 }
];
...
const state = {
  ...
  machineTypes: ["TopMatic", "Autocol", "TopModul (DTS4)", "TopModul (DTS3)", "MultiModul"],
  mapLocked: true,
...
const els = {
  ...
  builderObjectStation: document.querySelector("#builderObjectStation"),
  builderObjectAngle: document.querySelector("#builderObjectAngle"),
  ...
  builderSensorRequiredVisibilityPercent: document.querySelector("#builderSensorRequiredVisibilityPercent"),
  builderOrientationLabelSection: document.querySelector("#builderOrientationLabelSection"),
  builderServoAssist: document.querySelector("#builderServoAssist"),
  builderSensorOrientBottle: document.querySelector("#builderSensorOrientBottle"),
  builderObjectDepth: document.querySelector("#builderObjectDepth"),
  addMapObject: document.querySelector("#addMapObject"),
  updateMapObject: document.querySelector("#updateMapObject"),
  deleteMapObject: document.querySelector("#deleteMapObject"),
  ...
  simEditor: document.querySelector("#simEditor"),
  tableMap: document.querySelector("#tableMap"),
  viewTabButtons: [...document.querySelectorAll("[data-tab]")]
};
