...
(function installServoForgeFeedbackCenter(global) {
  ...
  const BUILD_MARKER = "anonymous-feedback-center-v95-20260812-1755";
    ...
    if (!dialog) {
      ...
      dialog.innerHTML = `
        <div class="sf-feedback-shell">
          ...
          <nav class="sf-feedback-tabs" aria-label="Feedback sections"><button type="button" class="active" data-feedback-tab="new">New Request</button><button type="button" data-feedback-tab="history">My Requests</button><button type="button" data-feedback-tab="admin">Support Admin</button></nav>
  ...
  global.LabelerFeedbackCenter = Object.freeze({ installed: true, version: 1, build: BUILD_MARKER, api, token, appContext, loadHistory, refreshAdmin });
