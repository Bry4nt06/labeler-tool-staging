...
function renderProgram() {
  ...
  els.program.innerHTML = `<table><thead><tr><th>HMI</th><th>${commandHeading}</th><th class="num">Table angle</th><th class="num override-heading">Table override</th><th class="num">Bottle angle</th><th class="num override-heading">Bottle override</th><th class="num">Table travel</th><th class="num">Bottle travel</th><th>Status</th><th class="num">Turn speed</th><th>Action</th></tr></thead><tbody></tbody></table>`;
  ...
  segments.forEach((row, index) => {
    ...
    if ((index + 1) % 8 === 0 && index < segments.length - 1) {
      ...
      divider.innerHTML = `<td colspan="11" style="height:5px;padding:0;border:0;background:transparent;"></td>`;
