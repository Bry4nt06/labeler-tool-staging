...
(function loadSimulationAndMapAccessIntegrations() {
  const modules = [
    ...
    "app/map-object-servo-orientation-integration.js?v=0.9.6-orientation-drivers-v1",
    "app/map-object-coder-after-wipe-integration.js?v=0.9.6-orientation-drivers-v1",
