...
(function installStagingBuildBannerAuthorityV2(global) {
  if (global.ServoForgeStagingBuildBannerAuthorityV2?.installed) return;
  ...
  function enforce() {
    ...
    try {
      ...
      if (global.ServoForgeBootstrapUpdatedAt) {
        global.SERVOFORGE_BUILD_UPDATED_AT = global.ServoForgeBootstrapUpdatedAt;
      }
  ...
  function install() {
    ...
    global.ServoForgeStagingBuildBannerAuthorityV2 = Object.freeze({
      installed: true,
      enforce,
