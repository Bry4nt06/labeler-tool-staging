...
assert.match(bootstrap,/anonymous-feedback-center-v95-20260812-1755/);
assert.match(serviceWorker,/anonymous-feedback-center-v95-20260812-1755/);
assert.equal(manifest.buildId,"anonymous-feedback-center-v95-20260812-1755");
