...
assert.match(bootstrap,/top-view-only-orientation-v84-20260811-1918/);
assert.match(serviceWorker,/top-view-only-orientation-v84-20260811-1918/);
assert.equal(manifest.buildId,"top-view-only-orientation-v84-20260811-1918");
console.log("Top-view-only Bottle Orientation v84 regression passed.");
