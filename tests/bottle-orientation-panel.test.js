...
assert.match(serviceWorker,/map-machine-settings-wipe-direction-v87-20260811-1940/);
assert.equal(manifest.buildId,"map-machine-settings-wipe-direction-v87-20260811-1940");
console.log("Top-view-only Bottle Orientation v87 baseline regression passed.");
