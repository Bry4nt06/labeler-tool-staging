...
assert.match(bootstrap, /side\-view\-grid\-degree\-reference\-v82\-20260811\-1852/);
assert.match(serviceWorker, /side\-view\-grid\-degree\-reference\-v82\-20260811\-1852/);
assert.equal(manifest.buildId, "side-view-grid-degree-reference-v82-20260811-1852");
console.log("Side-view grid and degree reference v82 regression passed.");
