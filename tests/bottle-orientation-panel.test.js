...
assert.match(bootstrap,/brand-selection-transaction-v92-20260811-2109/);
assert.match(serviceWorker,/brand-selection-transaction-v92-20260811-2109/);
assert.equal(manifest.buildId,"brand-selection-transaction-v92-20260811-2109");
