...
assert.match(bootstrap,/community-library-v97-20260812-1918/);
assert.match(serviceWorker,/community-library-v97-20260812-1918/);
assert.equal(manifest.buildId,"community-library-v97-20260812-1918");
