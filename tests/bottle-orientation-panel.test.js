...
assert.match(bootstrap,/public-ratings-v96-20260812-1821/);
assert.match(serviceWorker,/public-ratings-v96-20260812-1821/);
assert.equal(manifest.buildId,"public-ratings-v96-20260812-1821");
