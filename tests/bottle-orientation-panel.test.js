...
assert.match(serviceWorker, /head1-world-frame-top-view-v80-20260811-1830/);
assert.equal(manifest.buildId, "head1-world-frame-top-view-v80-20260811-1830");
console.log("Head 1 world-frame top view v80 regression passed.");
