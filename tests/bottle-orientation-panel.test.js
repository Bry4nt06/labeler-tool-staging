...
assert.match(bootstrap,/brand-selection-presentation-v93-20260811-2124/);
assert.match(serviceWorker,/brand-selection-presentation-v93-20260811-2124/);
assert.equal(manifest.buildId,"brand-selection-presentation-v93-20260811-2124");
