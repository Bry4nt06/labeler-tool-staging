...
assert.match(index, /id="showEntryExitDeadZoneOverlay"/); assert.match(index, /330° → 30°/); assert.match(index, /machine-direction-bottle-orientation-v78-20260811-1752/);
