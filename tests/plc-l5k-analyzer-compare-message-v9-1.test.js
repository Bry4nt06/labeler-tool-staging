...
test("v9.1 Compare layer remains local/read-only under the current v12.1 interlock-aware release", () => {
  ...
  assert.ok(analyzerV9 >= 0 && analyzerV9 < analyzerV10 && analyzerV10 < analyzerV11 && analyzerV11 < analyzerV12 && analyzerV12 < communicationCompare && communicationCompare < messageCompare && messageCompare < consistencyCompare && consistencyCompare < sequenceCompare && sequenceCompare < interlockCompare && interlockCompare < uiScript);
  assert.match(page, /v9\.1 MSG \/ MESSAGE/);
