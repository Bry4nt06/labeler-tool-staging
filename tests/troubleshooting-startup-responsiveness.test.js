...
test("v356 guard remains after all v361 diagnostic engines and immediately before the troubleshooting controller", () => {
  ...
  assert.ok(searchPrecedenceIndex > webIndex && guardIndex > searchPrecedenceIndex);
