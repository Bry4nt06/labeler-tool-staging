...
test("v351 encoder isolation validates on top of source-proven 00067 and alarm-stack layers", () => {
...
test("browser loads v351 engine after source bridge/analyzer and interactive UI after the app", () => {
